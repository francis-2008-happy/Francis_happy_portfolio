...
const Hero: React.FC = () => {
  ...
  return (
    <section
      id={SectionId.HERO}
      className="relative min-h-screen flex flex-col justify-center items-center pt-40 pb-10 overflow-hidden"
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center z-10">
        ...
        <div className="animate-fade-in-up animation-delay-200 flex flex-col items-center">
          <h2 className="text-2xl sm:text-3xl font-semibold text-slate-900 dark:text-white mb-4 tracking-tight">
            Hi, I'm Francis Happy
          </h2>
          <div className="flex flex-wrap justify-center gap-3 mb-10">
            {["AI Engineer", "Full Stack Developer", "Data Scientist"].map(
              (role, idx) => (
                <span
                  key={idx}
        ...
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold text-slate-900 dark:text-white tracking-tight leading-[1.1] mb-8 animate-fade-in-up animation-delay-400 max-w-5xl">
          Building Smart, Scalable Solutions <br className="hidden sm:block" />
        ...
        <p className="text-lg sm:text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed animate-fade-in-up animation-delay-600">
          I design and develop scalable full-stack applications powered by
          cutting-edge generative AI, transforming complex machine learning
          models into seamless and intuitive user experiences. My work bridges
          the gap between advanced AI technology and real-world applications,
          enabling businesses and individuals to harness the power of
          intelligent systems while maintaining high performance, reliability,
          and usability.
        </p>
